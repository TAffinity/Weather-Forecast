# 🌤️ Weather in the World

A responsive weather application built with **HTML**, **CSS**, and **JavaScript** that provides real-time weather information for cities around the world using the OpenWeather API.
